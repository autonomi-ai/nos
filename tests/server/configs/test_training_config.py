...
from nos.server.train.config import NoOpTrainingJobConfig, TrainingJobConfig  # noqa: F401


def test_training_job_config():
    with tempfile.TemporaryDirectory() as tmp_dir:
        cfg = NoOpTrainingJobConfig(working_directory=tmp_dir)
